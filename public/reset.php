    ...
    <div class="auth-wrapper forgot-wrapper">
        <aside class="auth-hero forgot-hero" aria-hidden="true">
            ...
            <div class="auth-hero-content">
                ...
                <h1 class="auth-hero-title forgot-title">Defina uma<br>nova senha</h1>
                <p class="auth-hero-text">Crie uma senha forte para proteger<br>sua conta e suas finanças.</p>
            </div>
        </aside>
        ...
        <main class="auth-main">
            <div class="auth-card forgot-card">
                ...
                <p class="auth-subtitle forgot-subtitle">Digite sua nova senha para continuar.</p>
                ...
                <p class="auth-foot-link">
                    <a href="/index.php?action=login">← Voltar para o login</a>
                </p>
            </div>
