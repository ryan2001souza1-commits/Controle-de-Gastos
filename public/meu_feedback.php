...
<?php include __DIR__ . '/partials/layout_start.php'; ?>
    ...
    <div class="fb-stats">
        <div class="fb-stat">
            ...
            <div class="fb-stat-body">
                ...
                <div class="fb-stat-value" style="color:#059669"><?= $totalCount ?></div>
        ...
        <div class="fb-stat">
            ...
            <div class="fb-stat-body">
                ...
                <div class="fb-stat-value" style="color:#1e40af"><?= $emAnalise ?></div>
        ...
        <div class="fb-stat">
            ...
            <div class="fb-stat-body">
                ...
                <div class="fb-stat-value" style="color:#0f6b3a"><?= $respondidos ?></div>
        ...
        <div class="fb-stat">
            ...
            <div class="fb-stat-body">
                ...
                <div class="fb-stat-value" style="color:#5b21b6"><?= $implement ?></div>
    ...
    <div class="fb-list">
        ...
        <?php if (!empty($feedbacks)): ?>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <div class="fb-row" style="padding:32px;text-align:center;color:#94a3b8;font-size:13px">Nenhum feedback encontrado. Envie seu primeiro feedback!</div>
        <?php endif; ?>
        ...
        <div class="fb-list-footer" style="display:flex;align-items:center;justify-content:space-between;padding:12px 22px;border-top:1px solid var(--color-border);background:var(--color-surface);font-size:12.5px;color:var(--color-text-3);flex-wrap:wrap;gap:12px">
            <div>Mostrando <?= $totalCount===0?0:1 ?> a <?= min(5, $totalCount) ?> de <?= $totalCount ?> feedbacks</div>
