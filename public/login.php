    ...
    <div class="auth-wrapper">
        <aside class="auth-side" aria-hidden="true">
            <div class="auth-side-inner">
                ...
                <h2 class="auth-side-title">Controle de Gastos</h2>
                <p class="auth-side-text">Gerencie suas finanças de forma simples, visual e inteligente.</p>
                <ul class="auth-side-features">
                    <li><span class="dot"></span> Lançamentos rápidos</li>
                    <li><span class="dot"></span> Metas e orçamentos</li>
                    <li><span class="dot"></span> Relatórios e gráficos</li>
                </ul>
            </div>
        </aside>
