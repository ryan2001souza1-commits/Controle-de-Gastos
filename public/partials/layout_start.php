...
$menuItems = [
    ...
    'assistente_ia' => ['href' => '/index.php?action=assistente_ia', 'label' => 'Assistente IA', 'icon' => 'zap'],
    ...
    'meu_feedback' => ['href' => '/index.php?action=meu_feedback', 'label' => 'Meu feedback', 'icon' => 'star'],
];
...
$sidebarIcons = [
    ...
    'star'      => '<svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24" aria-hidden="true"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>',
    'zap'       => '<svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24" aria-hidden="true"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>',
    'info'      => '<svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>',
];
