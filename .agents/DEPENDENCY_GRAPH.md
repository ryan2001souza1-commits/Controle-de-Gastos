...
Kit version: `2026.8.31` · 21 agents · 47 skills · 13 workflows
...
flowchart LR
  ...
  subgraph Agents
    ...
    A_governed_implementer["governed-implementer"]
  ...
  A_governed_implementer --> S_clean_code
  A_governed_implementer --> S_code_review_checklist
  A_governed_implementer --> S_vulnerability_scanner
  A_governed_implementer --> S_verify_changes
  A_governed_implementer --> S_testing_patterns
  A_governed_implementer --> S_lint_and_validate
  A_governed_implementer --> S_systematic_debugging
  A_governed_implementer --> S_architecture
